window.addEventListener('load', function () {
    ...
    function callWebService() {
        ...
        jQuery.ajax({
            url: "<https://ussouthcentral.services.azureml.net/workspaces/5416d432a1204c1eafcaf591ada1eba3/services/98d36c843be34d22b188e7ed9747750b/execute?api-version=2.0&details=true>",
            beforeSend: function (xhrObj) {
                xhrObj.setRequestHeader("Content-Type", "application/json;charset=utf-8");
                xhrObj.setRequestHeader("Ocp-Apim-Subscription-Key", "<bcbf443f32d44896b9cf79a719a73aa1>");
